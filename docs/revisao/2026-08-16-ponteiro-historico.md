# O ponteiro do CLAUDE.md como estava em 2026-08-16 — a história das trilhas, preservada

Este arquivo é a seção **"Leia no começo da sessão"** do `CLAUDE.md` tal como ela cresceu de 2026-07-25 a 2026-08-16 — ~610 linhas de narrativa empilhada, uma por sessão, cada uma escrita como "o estado de hoje" e nunca apagada. Em 16/08 a dona pediu a compactação: o `CLAUDE.md` passou a dizer só o estado corrente e onde estão as regras, e a narrativa veio inteira para cá, **sem uma palavra mudada**, porque as lições que ela conta (medição, corridas, worktree, régua) já moram nas regras do `METODO.md` e nos relatórios de execução — mas o caminho até elas é história, e história se guarda.
