...
| ~~higiene 🔵~~ ✅ `484f429b` (13 de 17; G11–G13 e o resto de G15 na S-CF3) | `docs/migracoes` do E217; âncora da `DEVOLUCAO` = `ancoraDeNegocio`; ponteiro de `ACOES_AUDITORIA` no spec; UF criar×editar; o `detalhe` do 409 do console (a contagem que a porta devolve); a constante 630/1140 copiada em `config.tsx`; erro-vira-silêncio na fila de atrasos e na locação da ficha; o comentário da comissão em `reservas.ts:600`; cache da fila de atrasos com geração; `varredura-datas-nao-aceitam-nulo` aninhado; dias vedados da 17ª com `data-regua` | B7, C8, C9, C11, C12, E2, E3, E4, G9, G11–G15, A6, A7 | lote |
