...
**18 sobras: 13 fechadas.** **As duas 🔴 e as seis 🟠 fecharam — não resta
nenhuma linha acima de 🟡.** As cinco abertas são 🟡: duas do diagnóstico
(S-M9, S-M10) e três nascidas da execução (S-M16, S-M17, S-M18).
