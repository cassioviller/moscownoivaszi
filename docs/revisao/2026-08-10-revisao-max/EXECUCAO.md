...
**18 sobras: 12 fechadas.** **As duas 🔴 e as seis 🟠 fecharam — não resta
nenhuma linha acima de 🟡.** As seis abertas são 🟡: três do diagnóstico
(S-M8, S-M9, S-M10) e três nascidas da execução (S-M16, S-M17, S-M18).
