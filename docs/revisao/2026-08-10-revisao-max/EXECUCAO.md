...
**18 sobras: 10 fechadas.** **As duas 🔴 e as seis 🟠 fecharam — não resta
nenhuma linha acima de 🟡.** As oito abertas são 🟡: cinco do diagnóstico
(S-M6, S-M8, S-M9, S-M10, S-M12) e três nascidas da execução
(S-M16, S-M17, S-M18).
