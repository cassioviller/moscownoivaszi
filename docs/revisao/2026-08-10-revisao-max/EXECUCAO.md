...
**18 sobras: 9 fechadas.** **As duas 🔴 e as seis 🟠 fecharam — não resta
nenhuma linha acima de 🟡.** As nove abertas são 🟡: seis do diagnóstico
(S-M6, S-M8, S-M9, S-M10, S-M12, S-M14) e três nascidas da execução
(S-M16, S-M17, S-M18).
