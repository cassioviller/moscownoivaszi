...
| Épico | Tese | Fecha | Estado |
|---|---|---|---|
| **E258** | o dia vira nas telas que o leem parado | S-RM11 🟡, S-RM12 🔵 | em execução (agente) |
| **E259** | a citação do manual, terceira passada | S-RM14 🔵, S-RM15 🔵, S-RM16 🔵 | em execução (agente) |
| ~~**E260**~~ | ~~a porta da contabilidade ganha cena~~ | S-RM13 🔵 | ✅ `<hash>` · [relatório](execucao/E260.md) — **a única sobra deste lote que não precisou de correção nenhuma no diagnóstico**, e a cena achou um 🟠 na mesma tela: a janela que ALARGA sozinha (S-RM17). O custo de descobri-la foi real — 302 recebimentos carimbados no `heliumdb`, restaurados por SQL. `e2e/15` vai de 6 para 7 testes |
