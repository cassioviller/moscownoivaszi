...
- [x] **Step 1: Trocar o teste m2 (RED) e adicionar os testes novos de manutenção**
...
- [x] **Step 2: Rodar os testes para ver o RED**
...
- [x] **Step 3: Reescrever o branch `manutencao` em `calcularJanelas`**
...
- [x] **Step 4: Rodar os testes para ver o GREEN**
...
- [x] **Step 1: Escrever os testes do fail-safe (RED)**
...
- [x] **Step 3: Adicionar `ErroBloqueio` e o campo em `Veredito`**
...
- [x] **Step 4: Reexportar `ErroBloqueio` no barrel**
...
- [x] **Step 5: Envolver o laço de `vestidoDisponivel` em try/catch**
...
- [x] **Step 1: Atualizar a decisão #2 (manutenção)**
...
- [x] **Step 2: Atualizar a decisão #5 (datas obrigatórias)**
...
- [x] **Step 1: Revalidar verde + tipos**
...
- [x] **Step 2: Atualizar o snapshot de `docs/workflow-skills.md`**
