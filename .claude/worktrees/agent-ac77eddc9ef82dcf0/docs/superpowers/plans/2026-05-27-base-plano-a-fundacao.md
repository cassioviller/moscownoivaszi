...
- [ ] **Step 1: Criar o projeto Next.js na pasta do repositório**
...
- [ ] **Step 3: Criar `.env.example`** (mesmo conteúdo, serve de modelo versionado)

```dotenv
DATABASE_URL="postgresql://moscow:moscow@localhost:5432/moscow_noivas?schema=public"
```

- [ ] **Step 4: Garantir `.env` ignorado pelo git**
...
- [ ] **Step 5: Subir o banco e verificar**
...
- [ ] **Step 3: Criar o singleton do client em `src/lib/db.ts`**
...
- [ ] **Step 1: Garantir que o banco está de pé**
...
- [ ] **Step 2: Criar e aplicar a migration inicial**
...
- [ ] **Step 3: Conferir no Prisma Studio (opcional, visual)**
