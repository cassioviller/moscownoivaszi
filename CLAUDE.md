...
2. **O registro da última sessão** —
   ...
   **Não há trilha nem plano em curso: o que resta é o BACKLOG DE SOBRAS das
   ...
   | Rodada 7 (design) | `2026-07-30-rodada-7-design/` | fechada — 4 sobras abertas (0 🟡 · 4 🔵): S-D36, S-D45, S-D46, S-D48 |
   ...
   **São 16 sobras abertas e nenhuma 🟠** — contadas nas três tabelas em
   2026-08-07, depois dos fechos de S40 (`475b991`, que pariu S42 e S43),
   S42 (`05cf366`), S-D44 (`c092e71`, que pariu a S-D48) e S-D47 (`015a0db`) — e **o plano das cinco fases está EXECUTADO de
   ...
   `cafe56c`, S10+S-A17 `8b9c574`, S30+S21 `d8ef73f`). Das 16 que restam,
   **11 são as perguntas da folha** (`2026-08-06-folha-de-perguntas.md`,
   esperando gente) e **5 são achados medidos no nascimento** (S41, S43,
   S-D45, S-D46, S-D48) — não há linha na
